...
<div class="mt-6">
    ...
    <div class="overflow-hidden rounded-xl border border-mercury bg-white shadow-sm"
        ...
        <div class="orders-filters grid grid-cols-1 gap-3 border-b border-mercury bg-skull/40 p-4 {{ $isTicket ? 'sm:grid-cols-2' : 'sm:grid-cols-2 lg:grid-cols-4' }}">
            <div>
            ...
            <div class="flex items-end gap-2 {{ $isTicket ? 'sm:col-span-2' : 'sm:col-span-2 lg:col-span-4' }}">
