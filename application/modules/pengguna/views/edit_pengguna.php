...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold">Ubah Data Pengguna</h6>
  </div>
  <div class="card-body">
    <form action="<?php echo site_url('pengguna/editAction');?>" method="post" autocomplete="off">
        ...
        <div class="col-xl-12 col-lg-12 mb-2 row-list">
          <li class="mb-2">
            <div class="section-list">
              ...
              <input name="realname" type="text" class="form-control" value="<?php echo $realname?>">
            </div>
          </li>
        </div>
        <div class="col-xl-12 col-lg-12 mb-2 row-list">
