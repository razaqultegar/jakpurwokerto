<div class="card shadow mb-4">
	...
	<div class="card-body">
		<?php
			$wilProvinsi = !empty($agtProvinsiNama) ? $agtProvinsiNama : $agtProvinsi;
			$wilKabupaten = !empty($agtKabupatenNama) ? $agtKabupatenNama : $agtKabupaten;
			$wilKecamatan = !empty($agtKecamatanNama) ? $agtKecamatanNama : $agtKecamatan;
			$wilKelurahan = !empty($agtKelurahanNama) ? $agtKelurahanNama : $agtKelurahan;
		?>
		<div class="row">
			<div class="col-xl-6 col-lg-6 mb-2 row-list">
				...
				<li class="mb-2">
					<div class="section-list">
						...
						<span class="content-list"><?php echo $agtAlamatJalan; ?><?php echo !empty($wilKelurahan) ? ', ' . $wilKelurahan : ''; ?><?php echo !empty($wilKecamatan) ? ', ' . $wilKecamatan : ''; ?><?php echo !empty($wilKabupaten) ? ', ' . $wilKabupaten : ''; ?><?php echo !empty($wilProvinsi) ? ', ' . $wilProvinsi : ''; ?></span>
					</div>
				</li>
			</div>
			<div class="col-xl-6 col-lg-6 mb-2 row-list">
